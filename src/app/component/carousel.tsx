        ...
        <div className="absolute inset-0 flex items-center justify-center perspective-[1200px]">
          {projects.map((project, i) => {
            ...
            return (
              ...
              >
                <div
                  className="rounded-2xl  overflow-hidden bg-[#1E1E1E] flex flex-col items-center gap-3 p-4 transition-all h-full"
                  style={{
                    boxShadow:
                      position === 0
                ...
                >
                  ...
                  {project.links && (
                    <a href={project.links} target="_blank" rel="noopener noreferrer" className="w-full">
                      <CButton className="w-full text-center ">
                        View on GitHub
                      </CButton>
                    </a>
                  )}
